...
const FormLabel = ({ className, ...props }: ComponentProps<typeof Root>) => {
  ...
  return (
    <Label className={cn(error && 'text-pink-800', className)} htmlFor={formItemId} {...props} />
  );
};
...
const FormDescription = ({ className, ...props }: ComponentProps<'p'>) => {
  ...
  return <p id={formDescriptionId} className={cn('text-pink-900/75', className)} {...props} />;
};
...
const FormMessage = ({ className, children, ...props }: ComponentProps<'p'>) => {
  ...
  return (
    <p id={formMessageId} className={cn('text-xs font-medium text-pink-800', className)} {...props}>
